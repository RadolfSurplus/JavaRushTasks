...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, Comparator.comparing((Stock s)->(String) s.get("name"))
                .thenComparing(s-> (Date) s.get("date"))
                .thenComparing(s-> (Double) s.get("last") - (Double) s.get("open")
